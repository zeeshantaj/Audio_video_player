 ...
 */
public class VideoFragment extends Fragment implements VideoAdapter.VideoClickInterface {
    ...
    ArrayList<VideoModel> videoRVModelArrayList;
    VideoAdapter videoRvAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        videoRvAdapter = new VideoAdapter(videoRVModelArrayList,getActivity(), this);
    ...
    private void getVideo() {
        ...
        if (cursor != null && cursor.moveToFirst()){
            do {
                ...
                videoRVModelArrayList.add(new VideoModel(videoTitle,videoPath,videoThumbnail));
